...
public class JsonGenerator {
    ...
    private static List<String> deviceList = Arrays.asList("ff96ae60-005a-4614-a9ef-a567d3be9863", "ff77a55b-0b0a-4430-9e25-6df51cdb0b05", "ff6e0f54-3c31-4085-8e03-1a4067dc2f05");

    public static String generate() {
        /*
        String jsonText = gson.toJson(new Data(UUID.randomUUID().toString(),
                random.nextInt(100),
